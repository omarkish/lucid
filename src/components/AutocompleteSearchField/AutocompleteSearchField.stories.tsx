...
import { AutocompleteSearchField, Underline } from '../../index';

//👇 Provide Storybook with the component name, 'section', any subcomponents and a description
export default {
	title: 'Controls/AutocompleteSearchField',
	component: AutocompleteSearchField,
	subcomponents: {
		'AutocompleteSearchField.Placeholder': AutocompleteSearchField.SearchField,
		'AutocompleteSearchField.Option': AutocompleteSearchField.Option,
		'AutocompleteSearchField.Option.Selected':
			AutocompleteSearchField.Option.Selected,
		'AutocompleteSearchField.OptionGroup': AutocompleteSearchField.OptionGroup,
		'AutocompleteSearchField.SearchField': AutocompleteSearchField.SearchField,
	},
	parameters: {
		docs: {
			description: {
				component: AutocompleteSearchField.peek.description,
			},
		},
	},
} as Meta;
...
const { Option, OptionGroup } = AutocompleteSearchField;
...
const Template: any = (args) => {
	return (
		<section>
			<AutocompleteSearchField {...args} style={{ maxWidth: '200px' }} />
		</section>
	);
};
...
export const Props = (args) => {
	return (
		<section>
			<h5>Loading</h5>
			<AutocompleteSearchField {...args} isLoading={true}>
				<Option>Alabama</Option>
			</AutocompleteSearchField>

			<h5>Disabled</h5>
			<AutocompleteSearchField {...args} isDisabled={true}>
				<Option>Alabama</Option>
			</AutocompleteSearchField>
		</section>
	);
