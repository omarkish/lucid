...
import * as reducers from './AutocompleteSearchField.reducers';

const { any, bool, func, number, oneOfType, shape, string, node } = PropTypes;

const cx = lucidClassNames.bind('&-AutocompleteSearchField');

/** Option Group Child Component */
const OptionGroup = (_props: IDropMenuOptionGroupProps): null => null;
OptionGroup.displayName = 'AutocompleteSearchField.OptionGroup';
OptionGroup.peek = {
	description: `
...
SearchFieldComponent.displayName = 'AutocompleteSearchField.SearchField';
...
export interface IAutocompleteSearchFieldOptionProps
...
Selected.displayName = 'AutocompleteSearchField.Option.Selected';
Selected.peek = {
	description: `
...
const Option = (_props: IAutocompleteSearchFieldOptionProps): null => null;

Option.displayName = 'AutocompleteSearchField.Option';
Option.peek = {
	description: `
...
export interface IAutocompleteSearchFieldPropsRaw extends StandardProps {
	hasReset?: boolean;
...
export type IAutocompleteSearchFieldProps = Overwrite<
	React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
	IAutocompleteSearchFieldPropsRaw
>;

export interface IAutocompleteSearchFieldState {
...
class AutocompleteSearchField extends React.Component<
	...
	IAutocompleteSearchFieldState
> {
	static displayName = 'AutocompleteSearchField';
	static peek = {
	...
	static propTypes = {
		/**
			Should be instances of {\`AutocompleteSearchField.Option\`}. Other direct
		...
		*/
		...
		/**
			Currently selected \`AutocompleteSearchField.Option\` index
		...
		*/,
		...
		onSubmit: any /**
		 * if SearchField onSubmit is called (i.e. return clicked in SearchField or
		 * magnifying glass is clicked in Search Field), the value in SearchField is
		 * returned to this handler
		 */,
	};
	...
	UNSAFE_componentWillMount(): void {
		...
		} = DropMenu.preprocessOptionData(this.props, AutocompleteSearchField);
	...
	UNSAFE_componentWillReceiveProps(
		nextProps: IAutocompleteSearchFieldProps
	): void {
		...
		const {
			...
			ungroupedOptionData,
			optionGroupDataLookup,
		} = DropMenu.preprocessOptionData(nextProps, AutocompleteSearchField);
	...
	renderOptionContent = (
		optionProps: IAutocompleteSearchFieldOptionProps,
		searchText: string
	): any => {
	...
	renderOption = ({
		...
		return (
			<DropMenu.Option
				key={'AutocompleteSearchFieldOption' + optionIndex}
		...
		const dropMenuOptions = _.map(
			...
			(optionGroupProps, optionGroupIndex) => (
				<DropMenu.OptionGroup
					key={'AutocompleteSearchFieldOptionGroup' + optionGroupIndex}
	...
	removeSelection = ({
		...
		props: IAutocompleteSearchFieldOptionProps;
	}): void => {
		const dropMenuProps = this.props.DropMenu;
	...
	render = () => {
		...
		const searchFieldProps = _.get(
			getFirst(props, AutocompleteSearchField.SearchField),
			'props',
			{}
		);
			...
			return (
				<div
					{...omitProps(
						passThroughs,
						undefined,
						_.keys(AutocompleteSearchField.propTypes)
					)}
		...
		return (
			...
			>
				...
				>
					...
					{isLoading ? (
						<DropMenu.Option
							key='AutocompleteSearchFieldLoading'
...
export default buildModernHybridComponent<
	IAutocompleteSearchFieldProps,
	IAutocompleteSearchFieldState,
	typeof AutocompleteSearchField
>(AutocompleteSearchField as any, { reducers });
export { AutocompleteSearchField as AutocompleteSearchFieldDumb };
